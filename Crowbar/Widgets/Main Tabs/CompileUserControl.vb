...
#Region "Init and Free"
	...
	Private Sub InitCompilerOptions()
		...
		Me.MoveMaterial_Checkbox.DataBindings.Add("Checked", TheApp.Settings, "CompileOptionMoveMaterialIsChecked", False, DataSourceUpdateMode.OnPropertyChanged)
		Me.MoveMaterial_Textbox.DataBindings.Add("Text", TheApp.Settings, "CompileOptionMoveMaterialPath", False, DataSourceUpdateMode.OnPropertyChanged)

		AddHandler Me.MoveMaterial_Textbox.DataBindings("Text").Parse, AddressOf FileManager.ParsePathFileName

		Me.UpdateCompilerOptionDefineBonesWidgets()
		Me.UpdateCompilerOptionMoveMaterial()
...
#Region "Child Widget Event Handlers"
	...
	Private Sub MoveMaterial_Textbox_DragDrop(sender As Object, e As DragEventArgs) Handles MoveMaterial_Textbox.DragDrop
		Dim pathFileNames() As String = CType(e.Data.GetData(DataFormats.FileDrop), String())
		Dim pathFileName As String = pathFileNames(0)
		If Directory.Exists(pathFileName) Then
			TheApp.Settings.CompileOptionMoveMaterialPath = pathFileName
		End If
	End Sub

	Private Sub MoveMaterial_Textbox_DragEnter(sender As Object, e As DragEventArgs) Handles MoveMaterial_Textbox.DragEnter
		If e.Data.GetDataPresent(DataFormats.FileDrop) Then
			e.Effect = DragDropEffects.Copy
		End If
	End Sub
	...
	Private Sub MoveMaterial_Button_Click(sender As Object, e As EventArgs) Handles MoveMaterial_Button.Click

		'NOTE: Using "open file dialog" instead of "open folder dialog" because the "open folder dialog" 
		'      does not show the path name bar nor does it scroll to the selected folder in the folder tree view.
		Dim outputPathWdw As New OpenFileDialog()

		outputPathWdw.Title = "Open the Material folder(ex. csgo/materials, cstrike/materials)"
		'If Directory.Exists(TheApp.Settings.CompileOutputFullPath) Then
		'	outputPathWdw.InitialDirectory = TheApp.Settings.CompileOutputFullPath
		'Else
		...
		If outputPathWdw.ShowDialog() = Windows.Forms.DialogResult.OK Then
			...
			TheApp.Settings.CompileOptionMoveMaterialPath = FileManager.GetPath(outputPathWdw.FileName)
		End If
	End Sub
...
#Region "Core Event Handlers"
	...
	Private Sub AppSettings_PropertyChanged(ByVal sender As System.Object, ByVal e As System.ComponentModel.PropertyChangedEventArgs)
		...
		ElseIf e.PropertyName = "CompileOptionVerboseIsChecked" Then
			...
			Me.SetCompilerOptionsText()
		ElseIf e.PropertyName = "CompileOptionMoveMaterialIsChecked" Then
			Me.UpdateCompilerOptionMoveMaterial
...
#Region "Private Methods"
	...
	Private Sub UpdateCompilerOptionMoveMaterial()
		Me.MoveMaterial_Button.Enabled = Me.MoveMaterial_Checkbox.Checked
		Me.MoveMaterial_Textbox.Enabled = Me.MoveMaterial_Checkbox.Checked
	End Sub
